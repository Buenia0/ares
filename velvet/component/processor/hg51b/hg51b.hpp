...
protected:
  ...
  auto disassembleADD(uint7 reg, uint5 shift) -> string;
  auto disassembleADD(uint8 imm, uint5 shift) -> string;
  auto disassembleAND(uint7 reg, uint5 shift) -> string;
  auto disassembleAND(uint8 imm, uint5 shift) -> string;
  auto disassembleASR(uint7 reg) -> string;
  auto disassembleASR(uint5 imm) -> string;
  auto disassembleCLEAR() -> string;
  auto disassembleCMP(uint7 reg, uint5 shift) -> string;
  auto disassembleCMP(uint8 imm, uint5 shift) -> string;
  auto disassembleCMPR(uint7 reg, uint5 shift) -> string;
  auto disassembleCMPR(uint8 imm, uint5 shift) -> string;
  auto disassembleHALT() -> string;
  auto disassembleINC(uint24& reg) -> string;
  auto disassembleJMP(uint8 data, uint1 far, const uint1& take) -> string;
  auto disassembleJSR(uint8 data, uint1 far, const uint1& take) -> string;
  auto disassembleLD(uint24& out, uint7 reg) -> string;
  auto disassembleLD(uint15& out, uint4 reg) -> string;
  auto disassembleLD(uint24& out, uint8 imm) -> string;
  auto disassembleLD(uint15& out, uint8 imm) -> string;
  auto disassembleLDL(uint15& out, uint8 imm) -> string;
  auto disassembleLDH(uint15& out, uint7 imm) -> string;
  auto disassembleMUL(uint7 reg) -> string;
  auto disassembleMUL(uint8 imm) -> string;
  auto disassembleNOP() -> string;
  auto disassembleOR(uint7 reg, uint5 shift) -> string;
  auto disassembleOR(uint8 imm, uint5 shift) -> string;
  auto disassembleRDRAM(uint2 byte, uint24& a) -> string;
  auto disassembleRDRAM(uint2 byte, uint8 imm) -> string;
  auto disassembleRDROM(uint24& reg) -> string;
  auto disassembleRDROM(uint10 imm) -> string;
  auto disassembleROR(uint7 reg) -> string;
  auto disassembleROR(uint5 imm) -> string;
  auto disassembleRTS() -> string;
  auto disassembleSHL(uint7 reg) -> string;
  auto disassembleSHL(uint5 imm) -> string;
  auto disassembleSHR(uint7 reg) -> string;
  auto disassembleSHR(uint5 imm) -> string;
  auto disassembleSKIP(uint1 take, const uint1& flag) -> string;
  auto disassembleST(uint7 reg, uint24& in) -> string;
  auto disassembleSUB(uint7 reg, uint5 shift) -> string;
  auto disassembleSUB(uint8 imm, uint5 shift) -> string;
  auto disassembleSUBR(uint7 reg, uint5 shift) -> string;
  auto disassembleSUBR(uint8 imm, uint5 shift) -> string;
  auto disassembleSWAP(uint24& a, uint4 reg) -> string;
  auto disassembleSXB() -> string;
  auto disassembleSXW() -> string;
  auto disassembleWAIT() -> string;
  auto disassembleWRRAM(uint2 byte, uint24& a) -> string;
  auto disassembleWRRAM(uint2 byte, uint8 imm) -> string;
  auto disassembleXNOR(uint7 reg, uint5 shift) -> string;
  auto disassembleXNOR(uint8 imm, uint5 shift) -> string;
  auto disassembleXOR(uint7 reg, uint5 shift) -> string;
  auto disassembleXOR(uint8 imm, uint5 shift) -> string;
};
